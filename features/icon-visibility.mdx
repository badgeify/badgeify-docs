...
![Show Transparent Icon](https://i.imgur.com/9s7D7P7.png)

*Example: Option to show transparent icon when no notifications*
...
![Pin Option](https://i.imgur.com/288G4rQ.png)
