...
This is a known issue with Ice's menu bar item management system, as documented in their [https://github.com/jordanbaird/Ice/issues/344](https://github.com/jordanbaird/Ice/issues/344). The issue appears to stem from how Ice handles menu bar items that:
